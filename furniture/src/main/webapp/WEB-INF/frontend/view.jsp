                ...
                <div class="header_top">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            <div class="switcher">
                                <ul>
                                    <li class="languages"><a href="#"><img src="assets\img\logo\fontlogo.jpg" alt="">
                                        English <i class="fa fa-angle-down"></i></a>
                                        <ul class="dropdown_languages">
                                            <li><a href="#"><img src="assets\img\logo\fontlogo.jpg" alt=""> English</a>
                                            </li>
                                            <li><a href="#"><img src="assets\img\logo\fontlogo2.jpg" alt=""> French </a>
                                            </li>
                                        </ul>
                                    </li>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="single_product">
                                                <div class="product_thumb">
                                                    <a href="single-product.html"><img src="${product.getImage()}"
                                           ...
                                           <span class="product_price"><fmt:formatNumber value="${product.getPrice()}"
                                                                                         type="currency"
                                                                                         pattern="#,### ₫"/></span>
                                                    <h3 class="product_title"><a href="single-product.html"><c:out
                                                            value="${product.getName()}"/></a></h3>
                                                </div>
                                        ...
                                        <div class="featured_product">
                                            ...
                                            <div class="row">
                                                ...
                                                <span class="product_price"><fmt:formatNumber
                                                        value="${product.getPrice()}" type="currency"
                                                        pattern="#,### ₫"/></span>
                                                                <h3 class="product_title"><a href="single-product.html"><c:out
                                                                        value="${product.getName()}"/></a></h3>
                                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="single_banner">
                                                    <a href="#"><img src="/image/sp2.jpg" alt=""></a>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="footer_widget">
                                    ...
                                    <div class="footer_widget_contect">
                                        <p><i class="fa fa-map-marker" aria-hidden="true"></i> 19 Interpro Road Madison,
                                            AL 35758, USA</p>
